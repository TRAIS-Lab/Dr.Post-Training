...
#   bash SFT/train/submit_all.sh --suite dolci --seeds 42            # first Dolci pass
...
case "$SUITE" in
    ...
    dolci)
        SETTINGS=(
            "dolci_inst_if:dolci_instruction:precise_if:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_mixed_if:dolci_mixed:precise_if:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_reason_code:dolci_reasoning:mbpp:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_mixed_code:dolci_mixed:mbpp:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_reason_mathpersona:dolci_reasoning:math_persona:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_mixed_mathpersona:dolci_mixed:math_persona:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_reason_math:dolci_reasoning:math:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_mixed_math:dolci_mixed:math:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_reason_mathpool:dolci_reasoning:math_pool:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_mixed_mathpool:dolci_mixed:math_pool:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_reason_mathv2:dolci_reasoning:math_v2:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_reason_mathbench:dolci_reasoning:math_bench:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_mixed_mathv2:dolci_mixed:math_v2:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
            "dolci_mixed_mathbench:dolci_mixed:math_bench:FullTraining-Full,LayerWiseSubset-Full,GlobalSubset-Full,BlockWiseSubset-Full,SublayerWiseSubset-Full"
        )
        # Target-only arms train on the whole D* file (128 rows) for the main step budget.
        TARGET_TASKS=(
            "math:dolci_reason_math:FullTraining-Full:100"
        )
