...
samsum_train_dataset = partial(samsum_dataset, source="samsum", split="train")
samsum_validation_dataset = partial(samsum_dataset, source="samsum", split="validation")
samsum_test_dataset = partial(samsum_dataset, source="samsum", split="test")