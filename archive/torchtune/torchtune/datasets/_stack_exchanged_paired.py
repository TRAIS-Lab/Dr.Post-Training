...
from torchtune.datasets._preference import PreferenceDataset, PreferenceDatasetFT
...
def stack_exchanged_paired_dataset_val(
    tokenizer: Tokenizer,
    source: str = "lvwerra/stack-exchange-paired",
    max_seq_len: int = 1024,
) -> PreferenceDataset:
...
def stack_exchanged_paired_dataset_test(
    tokenizer: Tokenizer,
    source: str = "lvwerra/stack-exchange-paired",
    max_seq_len: int = 1024,
) -> PreferenceDataset:
...
def stack_exchanged_paired_dataset_ft(
    tokenizer: Tokenizer,
    source: str = "lvwerra/stack-exchange-paired",
    max_seq_len: int = 1024,
) -> PreferenceDataset:
