...
This is the implementation of *Dr. Post-Training: A Data Regularization Perspective on LLM Post-Training*.
...
```bash
# The RLVR experiment builds on verl, included as a git submodule pinned to upstream commit
# 65eb5a15058d73ef54064092222b7af67d658241 (https://github.com/volcengine/verl, v0.7.0 + 74 commits).
# In a git checkout: clone with --recursive, or initialize the submodule afterwards
git submodule update --init --recursive
# From an unpacked archive (no .git): fetch that commit into RLVR/verl
git clone https://github.com/volcengine/verl.git RLVR/verl && git -C RLVR/verl checkout 65eb5a15058d73ef54064092222b7af67d658241
```
...
# RLVR training
./submit.sh RLVR/train.sh -c configs/math -m LayerWiseSubset-Full
