...
class SelectionTrainerConfig:
    ...
    # Hook the token embedding and lm_head in addition to the block Linear layers
    # (same coverage as the SFT hook). False hooks only the block Linear layers.
    ...
    # - "nice": L = -E[raw_reward * log_prob], the NICE (Wang et al., ICML 2025) Monte-Carlo policy
    #     gradient of the metric without baseline or normalization.
