...
# GREATS Online Data Selection for RLVR
# This script runs RLVR with gradient-based data selection (GREATS method)
#
# Key differences from baseline DOTS:
# - DOTS: Uses difficulty to select training samples offline (per-epoch)
# - GREATS: Uses difficulty to select validation set dynamically,
