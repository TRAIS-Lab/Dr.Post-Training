...
DataParallelPPOActorWithSelection for Streaming/GREATS gradient-based selection.
...
Selection config keys (passed via setup_selection):
    - method: "Streaming", "GREATS", or "NA" (default)
...
class SelectionActorRolloutRefWorker(BaseActorRolloutRefWorker):
    ...
    actor handles Streaming/GREATS selection internally in update_policy().
